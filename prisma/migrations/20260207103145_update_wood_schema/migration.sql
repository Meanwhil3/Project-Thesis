/*
  ...
  - You are about to drop the column `wood_Texture` on the `Wood` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Wood" DROP COLUMN "wood_Texture",
ADD COLUMN     "wood_texture" VARCHAR(255);
